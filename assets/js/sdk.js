...
function WebChatbotListener() {
	...
	this.createBox = function() {
		...
		html = html
			...
			+ "</div>"
			+ "</div>"
			+ "<div id='" + this.prefix + "yandex' class='" + this.prefix + "yandex'><span>Powered by <a target='_blank' href='https://translate.yandex.com/'>Yandex.Translate</a></span></div>"
			+ "</div>"
			+ "</div>"
			+ "<div id='" + this.prefix + "boxbar' class='" + this.prefix + "boxbar'>"
				+ "<div id='" + this.prefix + "boxbar2' class='" + this.prefix + "boxbar2'>"
